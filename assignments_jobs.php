        ...
        <ul class="jobs__list">
            <li class="jobs__list-header">
                ...
                $items= [
                    ...
                    ['name' => 'Elternelement', 'mod-class' => 'parent'],
            ...
            <?php foreach ($items as $item) { ?>
                <li class="jobs__list-item">
                    ...
                    <input type="text" class="jobs__list-input jobs__list-input--designation" placeholder="<?= $item['placeholder'] ?>">
                    <input type="text" class="jobs__list-input jobs__list-input--parent">
            ...
            <li class="jobs__list-item">
                ...
                <input type="text" class="jobs__list-input jobs__list-input--designation"">
                <input type="text" class="jobs__list-input jobs__list-input--parent">
                <div class="jobs__checkbox-label jobs__checkbox-label--diff">
                </div>
            </li>
        </ul>
